...
namespace SMSSceneReader
{
    public partial class MainForm : Form
    {
        ...
        public void LoadFile(string path)
        {
            ...
            Regex rgx = new Regex(".+\\\\(.+?)\\\\.+?\\\\(.+?)\\\\.+?\\\\.+?\\\\.+");
            Match sceneInfo = rgx.Match(path);
            Globals.gameName = sceneInfo.Groups[1].Value;
            Globals.sceneName = sceneInfo.Groups[2].Value;
        ...
        /* Run hack in playtest mode & Setup */
        
        private void playToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (saveToolStripMenuItem.Enabled)
                saveToolStripMenuItem_Click(sender, new EventArgs());
            string[] arrLine = File.ReadAllLines("C:\\Users\\chris\\Documents\\Dolphin Emulator\\GameSettings\\GMSE01.ini");
            arrLine[5] = "3860" + Globals.mapIDs[Globals.sceneName] + " 38000000";
            File.WriteAllLines("C:\\Users\\chris\\Documents\\Dolphin Emulator\\GameSettings\\GMSE01.ini", arrLine);
            System.Diagnostics.Process.Start("C:\\Users\\chris\\Desktop\\SMSHacking\\Playtest.bat", Globals.gameName + " " + Globals.sceneName);
        }
